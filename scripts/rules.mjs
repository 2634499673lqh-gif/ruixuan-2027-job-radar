...
const tracks = [
  ...
  { name: "市场品牌", terms: ["品牌营销", "市场推广", "市场营销", "市场策划", "品牌策划", "公关", "新媒体运营", "社媒运营", "用户增长", "市场研究"], priority: "相邻可投", score: 76 },
  { name: "销售渠道", terms: ["销售管理", "渠道销售", "海外销售", "国际销售", "外销业务", "内销业务", "业务拓展", "渠道管理", "门店销售"], priority: "补充选择", score: 70 },
  { name: "项目客户", terms: ["项目管理", "项目交付", "客户成功", "解决方案", "售后专员", "客诉专员", "客户运营", "项目助理"], priority: "补充选择", score: 69 },
  { name: "零售管理", terms: ["零售管理", "门店运营", "货品管理", "商品管理", "品类运营", "陈列管理"], priority: "补充选择", score: 68 },
  { name: "人力职能", terms: ["人力资源", "招聘专员", "培训专员", "行政专员", "总经理助理", "雇主品牌"], priority: "补充选择", score: 65 },
  { name: "财务风控", terms: ["财务管理", "财务专员", "财经管理", "审计", "风控", "证券专员", "合规", "法务"], priority: "补充选择", score: 64 },
